...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CloudStackBundle.equivalent_bundle'
        db.add_column(u'dbaas_cloudstack_cloudstackbundle', 'equivalent_bundle',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbaas_cloudstack.CloudStackBundle'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CloudStackBundle.equivalent_bundle'
        db.delete_column(u'dbaas_cloudstack_cloudstackbundle', 'equivalent_bundle_id')
    ...
    models = {
        u'dbaas_cloudstack.cloudstackbundle': {
            ...
            'equivalent_bundle': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dbaas_cloudstack.CloudStackBundle']", 'null': 'True', 'blank': 'True'}),
        ...
        u'dbaas_cloudstack.cloudstackoffering': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'equivalent_offering': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dbaas_cloudstack.CloudStackOffering']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        u'physical.environment': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'equivalent_environment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['physical.Environment']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'physical.host': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'future_host': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['physical.Host']", 'null': 'True', 'blank': 'True'}),
        ...
        u'physical.plan': {
            ...
            'equivalent_plan': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['physical.Plan']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
