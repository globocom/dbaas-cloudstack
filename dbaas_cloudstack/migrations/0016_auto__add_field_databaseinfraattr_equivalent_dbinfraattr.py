...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseInfraAttr.equivalent_dbinfraattr'
        db.add_column(u'dbaas_cloudstack_databaseinfraattr', 'equivalent_dbinfraattr',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbaas_cloudstack.DatabaseInfraAttr'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseInfraAttr.equivalent_dbinfraattr'
        db.delete_column(u'dbaas_cloudstack_databaseinfraattr', 'equivalent_dbinfraattr_id')
