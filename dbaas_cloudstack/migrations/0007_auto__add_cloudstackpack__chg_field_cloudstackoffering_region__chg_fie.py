...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CloudStackPack'
        db.create_table(u'dbaas_cloudstack_cloudstackpack', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('userdata', self.gf('django.db.models.fields.TextField')()),
            ('offering', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cs_offering_packs', to=orm['dbaas_cloudstack.CloudStackOffering'])),
            ('is_ha', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('engine_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cs_packs', to=orm['physical.EngineType'])),
        ))
        db.send_create_signal(u'dbaas_cloudstack', ['CloudStackPack'])


        # Changing field 'CloudStackOffering.region'
        db.alter_column(u'dbaas_cloudstack_cloudstackoffering', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['dbaas_cloudstack.CloudStackRegion']))

        # Changing field 'CloudStackBundle.region'
        db.alter_column(u'dbaas_cloudstack_cloudstackbundle', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['dbaas_cloudstack.CloudStackRegion']))

    def backwards(self, orm):
        # Deleting model 'CloudStackPack'
        db.delete_table(u'dbaas_cloudstack_cloudstackpack')


        # Changing field 'CloudStackOffering.region'
        db.alter_column(u'dbaas_cloudstack_cloudstackoffering', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dbaas_cloudstack.CloudStackRegion']))

        # Changing field 'CloudStackBundle.region'
        db.alter_column(u'dbaas_cloudstack_cloudstackbundle', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dbaas_cloudstack.CloudStackRegion']))
