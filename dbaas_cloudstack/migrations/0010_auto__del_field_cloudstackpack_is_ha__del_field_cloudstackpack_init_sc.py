...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CloudStackPack.is_ha'
        db.delete_column(u'dbaas_cloudstack_cloudstackpack', 'is_ha')
        ...
        db.add_column(u'dbaas_cloudstack_cloudstackpack', 'script',
                      self.gf('django.db.models.fields.TextField')(default='echo 1'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CloudStackPack.is_ha'
        db.add_column(u'dbaas_cloudstack_cloudstackpack', 'is_ha',
