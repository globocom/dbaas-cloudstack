...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OfferingGroup'
        db.create_table(u'dbaas_cloudstack_offeringgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'dbaas_cloudstack', ['OfferingGroup'])

        # Adding M2M table for field offerings on 'OfferingGroup'
        m2m_table_name = db.shorten_name(u'dbaas_cloudstack_offeringgroup_offerings')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('offeringgroup', models.ForeignKey(orm[u'dbaas_cloudstack.offeringgroup'], null=False)),
            ('cloudstackoffering', models.ForeignKey(orm[u'dbaas_cloudstack.cloudstackoffering'], null=False))
        ))
        db.create_unique(m2m_table_name, ['offeringgroup_id', 'cloudstackoffering_id'])

        # Adding field 'PlanAttr.offering_group'
        db.add_column(u'dbaas_cloudstack_planattr', 'offering_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbaas_cloudstack.OfferingGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OfferingGroup'
        db.delete_table(u'dbaas_cloudstack_offeringgroup')

        # Removing M2M table for field offerings on 'OfferingGroup'
        db.delete_table(db.shorten_name(u'dbaas_cloudstack_offeringgroup_offerings'))

        # Deleting field 'PlanAttr.offering_group'
        db.delete_column(u'dbaas_cloudstack_planattr', 'offering_group_id')
    ...
    models = {
        ...
        u'dbaas_cloudstack.hostattr': {
            ...
            'bundle': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dbaas_cloudstack.CloudStackBundle']", 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'dbaas_cloudstack.planattr': {
            ...
            'configuration_script': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_database_script': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'start_replication_script': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'userdata': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
