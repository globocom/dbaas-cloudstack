...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BundleGroup'
        db.create_table(u'dbaas_cloudstack_bundlegroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'dbaas_cloudstack', ['BundleGroup'])

        # Adding M2M table for field bundles on 'BundleGroup'
        m2m_table_name = db.shorten_name(u'dbaas_cloudstack_bundlegroup_bundles')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bundlegroup', models.ForeignKey(orm[u'dbaas_cloudstack.bundlegroup'], null=False)),
            ('cloudstackbundle', models.ForeignKey(orm[u'dbaas_cloudstack.cloudstackbundle'], null=False))
        ))
        db.create_unique(m2m_table_name, ['bundlegroup_id', 'cloudstackbundle_id'])

        # Adding field 'PlanAttr.bundle_group'
        db.add_column(u'dbaas_cloudstack_planattr', 'bundle_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbaas_cloudstack.BundleGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BundleGroup'
        db.delete_table(u'dbaas_cloudstack_bundlegroup')

        # Removing M2M table for field bundles on 'BundleGroup'
        db.delete_table(db.shorten_name(u'dbaas_cloudstack_bundlegroup_bundles'))

        # Deleting field 'PlanAttr.bundle_group'
        db.delete_column(u'dbaas_cloudstack_planattr', 'bundle_group_id')
