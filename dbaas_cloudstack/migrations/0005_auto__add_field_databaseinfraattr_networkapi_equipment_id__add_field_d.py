...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseInfraAttr.networkapi_equipment_id'
        db.add_column(u'dbaas_cloudstack_databaseinfraattr', 'networkapi_equipment_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatabaseInfraAttr.networkapi_ip_id'
        db.add_column(u'dbaas_cloudstack_databaseinfraattr', 'networkapi_ip_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseInfraAttr.networkapi_equipment_id'
        db.delete_column(u'dbaas_cloudstack_databaseinfraattr', 'networkapi_equipment_id')

        # Deleting field 'DatabaseInfraAttr.networkapi_ip_id'
        db.delete_column(u'dbaas_cloudstack_databaseinfraattr', 'networkapi_ip_id')
