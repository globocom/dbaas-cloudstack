...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LastUsedBundle'
        db.create_table(u'dbaas_cloudstack_lastusedbundle', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cs_history_plan', to=orm['physical.Plan'])),
            ('bundle', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cs_history_bundle', to=orm['dbaas_cloudstack.CloudStackBundle'])),
        ))
        db.send_create_signal(u'dbaas_cloudstack', ['LastUsedBundle'])

        # Adding unique constraint on 'LastUsedBundle', fields ['plan', 'bundle']
        db.create_unique(u'dbaas_cloudstack_lastusedbundle', ['plan_id', 'bundle_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LastUsedBundle', fields ['plan', 'bundle']
        db.delete_unique(u'dbaas_cloudstack_lastusedbundle', ['plan_id', 'bundle_id'])

        # Deleting model 'LastUsedBundle'
        db.delete_table(u'dbaas_cloudstack_lastusedbundle')
