...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CloudStackPack.userdata'
        db.delete_column(u'dbaas_cloudstack_cloudstackpack', 'userdata')

        # Adding field 'CloudStackPack.init_script'
        db.add_column(u'dbaas_cloudstack_cloudstackpack', 'init_script',
                      self.gf('django.db.models.fields.TextField')(default='Initialize me '),
                      keep_default=False)

        # Adding field 'CloudStackPack.stop_script'
        db.add_column(u'dbaas_cloudstack_cloudstackpack', 'stop_script',
                      self.gf('django.db.models.fields.TextField')(default='Initialize Me'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CloudStackPack.userdata'
        db.add_column(u'dbaas_cloudstack_cloudstackpack', 'userdata',
                      self.gf('django.db.models.fields.TextField')(default='Initialize me'),
                      keep_default=False)

        # Deleting field 'CloudStackPack.init_script'
        db.delete_column(u'dbaas_cloudstack_cloudstackpack', 'init_script')

        # Deleting field 'CloudStackPack.stop_script'
        db.delete_column(u'dbaas_cloudstack_cloudstackpack', 'stop_script')
    ...
    models = {
        ...
        u'dbaas_cloudstack.cloudstackpack': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'init_script': ('django.db.models.fields.TextField', [], {}),
            ...
            'stop_script': ('django.db.models.fields.TextField', [], {}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
