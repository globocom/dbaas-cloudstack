...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CloudStackOffering.memory_size_mb'
        db.add_column(u'dbaas_cloudstack_cloudstackoffering', 'memory_size_mb',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CloudStackOffering.cpus'
        db.add_column(u'dbaas_cloudstack_cloudstackoffering', 'cpus',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CloudStackOffering.memory_size_mb'
        db.delete_column(u'dbaas_cloudstack_cloudstackoffering', 'memory_size_mb')

        # Deleting field 'CloudStackOffering.cpus'
        db.delete_column(u'dbaas_cloudstack_cloudstackoffering', 'cpus')
