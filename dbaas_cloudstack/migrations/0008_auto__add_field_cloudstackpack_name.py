...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CloudStackPack.name'
        db.add_column(u'dbaas_cloudstack_cloudstackpack', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Pack Name', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CloudStackPack.name'
        db.delete_column(u'dbaas_cloudstack_cloudstackpack', 'name')
